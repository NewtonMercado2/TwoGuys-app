...
?>
                            ...
                            <td>   
                                ...
                                <form action="editar_Tra.php" method="POST">
                                    <input type="hidden" value="<?php echo $mostrar['Id_trabajador']?>" name="txtIDe"readonly>
                                    <td> <input type="submit" value="Editar" name="bt_editar_Tra"> </td>
                                </form> 

                                <form action="eliminar_Tra.php" method="POST">
                                <input type="hidden" value="<?php echo $mostrar['Id_trabajador']?>" name="txtID"readonly>
