...
?>                            
                        <tr>
                            <td> <?php echo $mostrar['numero_documento_clienteFK'] ?> </td>
                            ...
                            <td>
                            <form action="editar_agendamientos.php" method="POST">
                                <input type="hidden" value="<?php echo $mostrar['numero_documento_clienteFK']?>" name="txtIDe" readonly>
                                <td> <input type="submit" value="Editar" name="bt_editar_agenda"> </td>
                                </form>
                            </td>
                            </form> 
