...
<?php
    $ID = $_POST['txtIDe'];
    $sql="SELECT * FROM vehiculo where placa_vehiculo ='$ID'";
...
?>
                            ...
                            <td> <input type="text" value="<?php echo $mostrar['placa_vehiculo'] ?>" name="pla_veh" readonly> </td>
                            <td> <input type="text" value="<?php echo $mostrar['marca_vechiculo'] ?>" name="marca_veh"></td>
                            <td> <input type="text" value=" <?php echo $mostrar['modelo'] ?>" name="modelo"></td>
                            <td> <input type="submit" value="Actualizar" name="act_veh">        
