...
?>
                            <tr>
                            <td> <?php echo $mostrar['codigo_de_servicio'] ?> </td>
                            <td> <?php echo $mostrar['plan_servicio'] ?> </td>
                            <td> <?php echo $mostrar['tipo_de_servicio'] ?> </td>
                            <td> <?php echo $mostrar['valor'] ?> </td>
                            <td> 
                                <form action="editar_servicio.php" method="POST">
                                    <input type="hidden" value="<?php echo $mostrar['codigo_de_servicio']?>" name="txtIDe"readonly>
                                    <td> <input type="submit" value="Editar" name="bt_editar_serv"> </td>
                                </form>        

                                <form action="eliminar_servicio.php" method="POST">
                                <input type="hidden" value="<?php echo $mostrar['codigo_de_servicio']?>" name="txtID"readonly>
