...
<body id="page-top">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Editar registro de cliente</h6>
        </div>
        <div class="card-body">
...
<?php
    $ID = $_POST['txtIDe'];
    $sql="SELECT * FROM cliente where numero_de_documento ='$ID'";
...
?>
                        ...
                        <form action="procesarEdicion.php" method="POST">
                            ...
                            <td> <input type="number" value="<?php echo $mostrar['numero_de_documento'] ?>" name="num_Doce" readonly> </td>
                            <td> <input type="number" value="<?php echo $mostrar['numero_de_telefono'] ?>" name="num_tele" required></td>
                            <td> <input type="email" value="<?php echo $mostrar['correo'] ?>" name="correoe" required></td>
                            <td> <input type="text" value="<?php echo $mostrar['contraseña'] ?>" name="contraseñae" required> </td>
                            <td> <input type="submit" value="actualizar" name="act_cli"> </td>
