        ...
        <div class="menu">
            ...
            <nav>
                <ul>
                    ...
                    <li class="lista"><a href="mostrar_servicios.php">Registros de servicios</a></li>
...
<?php
$ID = $_POST['txtIDe'];
    $sql="SELECT * FROM servicio where codigo_de_servicio='$ID'";
...
?>
                            ...
                            <td> <input type="text" value="<?php echo $mostrar['codigo_de_servicio'] ?>" name="cod_ser" readonly> </td>
                            <td> <input type="text" value="<?php echo $mostrar['plan_servicio'] ?>" name="plan"></td>
                            <td> <input type="text" value="<?php echo $mostrar['tipo_de_servicio'] ?>" name="tipo">  </td>
                            <td> <input type="number" value="<?php echo $mostrar['valor'] ?>" name="valor"></td>
                            <td> <input type="submit" value="actualizar" name="act_serv"> </td>
                            </tr>
                            <?php
}
                        ?>
