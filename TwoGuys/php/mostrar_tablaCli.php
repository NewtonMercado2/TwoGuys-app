                        ...
                        <tr>
                            ...
                            <td>  
                                ...
                                <form action="editar_Cli.php" method="POST">
                                    <input type="hidden" value="<?php echo $mostrar['numero_de_documento']?>" name="txtIDe"readonly>
                                    <td> <input type="submit" value="Editar" name="bt_editar_cli"> </td>
                                </form> 
                            
                            
                                <form action="eliminar_Cli.php" method="POST">
                                <input type="hidden" value="<?php echo $mostrar['numero_de_documento']?>" name="txtID"readonly>
