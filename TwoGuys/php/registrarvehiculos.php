...
<head>
    ...
    <link rel="stylesheet" href="../bootstrap-5.2.0-dist/css/index.css">
...
<body>
        ...
        <div class="navbar navbar-expand-lg">
            ...
            <nav>
                <ul>
                    ...
                    <li class="lista"><a href="../php/ver_vehiculos.php">VEHICULOS</a></li>    
                    <li class="lista"><a href="../php/dashboard_clientes.php">ESTADO DEL VEHICULO</a></li>
                    <li class="lista  me-2" aria-current="page">USUARIO: <?php echo $mostar['nombre']; ?></li>
    ...
    <section class="formularios">
        <form action="../php/conexion.php" method="post">
            ...
            <div class="form" >
                <h4>Formulario Registro Vehiculo</h4>
              
                <input type="text" id="Placa_veh_cli" name="Placa_veh_cli" placeholder="Placa" >
                <input type="text" id="Marca__veh_cli" name="Marca__veh_cli" placeholder="Marca" >
                <input type="text" id="modelo_veh_cli" name="modelo_veh_cli" placeholder="modelo" >
                
                <button class="info" type="submit" name="bt_reg_veh_cli">Enviar Registro</button>
